        ...
        <div className=" pt-16 pb-16 sm:pb-32">
          <div className=" mx-6 sm:mx-12 lg:mx-32">
            ...
            <p className=" text-xl sm:text-2xl mt-8 sm:mt-12">
              ...
              Hi, I'm Aman, a{" "}
              <span className="text-orange-300">MERN Stack Developer</span> with
              a strong foundation in building scalable and user-friendly web
              ...
              With hands-on experience across both frontend and backend
              development, I’m passionate about turning ideas into clean,
              efficient, and responsive digital solutions. I also have a
